...
This project presents the design and pricing of a **Climate Protection Option (CDO)** inspired by Hull's *Options, Futures and Other Derivatives*.The option is designed to protect firms against financial losses caused by extreme summer heat.
